        ...
        <div class="dropdown-item result" v-if="paginatedRecords.data">
            <div class="information">
                ...
                <table class="table is-bordered is-hoverable is-striped is-narrow is-fullwidth is-size-7">
                    <thead>
                        <tr>
                            <th style="width:160px;">{{ $t('words.issuance-return-number') }}</th>
                            <th>{{ $t('words.date') }}</th>
                    ...
                    <tbody>
                        <tr v-for="record in paginatedRecords.data" class="pointer" @click="recordSelected(record)">
                            <td>{{ record.code }}</td>
                            <td class="has-text-right">{{ record.return_date_human }}</td>
    ...
    export default {
        ...
        methods: {
            ...
            changePage(pageNumber) {
                ...
                if(this.paginatedRecords && this.paginatedRecords.length) {
