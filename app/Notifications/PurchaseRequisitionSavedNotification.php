...
class PurchaseRequisitionSavedNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ->subject($this->purchaseRequisition->number . ' - new purchase requisition was saved')
                    ->greeting('Notification')
                    ->line('A new purchase requisition was saved - ' . $this->purchaseRequisition->number)
